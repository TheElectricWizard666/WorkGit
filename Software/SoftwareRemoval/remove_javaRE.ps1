<#
The script removes automaticaly ALL THE VERSIONS of Oracle Java Runtime Environment from the PC.
To keep some Versions of Java installed, update Line 16 of the script.
...
$VersionsToKeep = @('Java 8 Update 321')
